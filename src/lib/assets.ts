...
export const characters: Character[] = [
  ...
  },
  {
    ...
    sprites: [
      ...
      { url: ROOT + '/characters/katsumi/apron knife2.webp', name: 'Apron Yandere Knife Alternate' },
  ...
  },
  {
    ...
    sprites: [
      ...
      { url: ROOT + '/characters/shizuka/green tilt right.webp', name: 'Tilting Head', devName: 'tiltright' },
  ...
  },
  {
    ...
    namebox: 'white',
    sprites: [
      { url: ROOT + '/characters/random-girl/random girl.webp', name: 'Default', devName: 'pnormal' },
      { url: ROOT + '/characters/random-girl/random girl angry.webp', name: 'Angry (with mark)', devName: 'angy' },
      { url: ROOT + '/characters/random-girl/random girl angry1.webp', name: 'Angry', devName: 'angy1' },
      { url: ROOT + '/characters/random-girl/random girl surprise.webp', name: 'Surprised (with mark)', devName: 'surprise' },
      { url: ROOT + '/characters/random-girl/random girl surprise1.webp', name: 'Surprised', devName: 'surprise1'},
      { url: ROOT + '/characters/random-girl/random girl wat.webp', name: 'Shocked', devName: 'wat' },
    ]
  },
  {
    name: 'Teacher',
  ...
  },
  {
    ...
    namebox: 'white',
    sprites: [
      { url: ROOT + '/characters/silhouette/bun.webp', name: 'Classmate 1 "Bun"', speakerName: 'Classmate 1', devName: 'rc1' },
      { url: ROOT + '/characters/silhouette/trash.webp', name: 'Classmate 2 "Trash"', speakerName: 'Classmate 2', devName: 'rc2' },
      { url: ROOT + '/characters/silhouette/gyaru.webp', name: 'Classmate 3 "Gyaru"', speakerName: 'Classmate 3', devName: 'rc3' },
      { url: ROOT + '/characters/silhouette/lily.webp', name: 'Classmate 4 "Lily"', speakerName: 'Classmate 4', devName: 'rc4' },
      { url: ROOT + '/characters/silhouette/fluffy.webp', name: 'Classmate 5 "Fluffy"', speakerName: 'Classmate 5', devName: 'rc5' },
    ]
  }
];
