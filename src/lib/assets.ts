...
export const characters: Character[] = [
	...
	},
	{
		...
		namebox: 'green',
		sprites: [
			{ url: ROOT + '/thirdparty/eli/EliAnxiousArm1.png', name: 'Anxious Arm1' },
			{ url: ROOT + '/thirdparty/eli/EliAnxiousArm2.png', name: 'Anxious Arm2' },
			{ url: ROOT + '/thirdparty/eli/EliAnxiousTalk.png', name: 'Anxious Talk' },
			{ url: ROOT + '/thirdparty/eli/EliBlush.png', name: 'Blush' },
			{ url: ROOT + '/thirdparty/eli/EliBruh.png', name: 'Bruh' },
			{ url: ROOT + '/thirdparty/eli/EliIsTerrified.png', name: 'Is Terrified' },
			{ url: ROOT + '/thirdparty/eli/EliIsTired.png', name: 'Is Tired' },
			{ url: ROOT + '/thirdparty/eli/EliLookingAway.png', name: 'Looking Away' },
			{ url: ROOT + '/thirdparty/eli/EliNeutral.png', name: 'Neutral' },
			{ url: ROOT + '/thirdparty/eli/EliNeutralArm.png', name: 'Neutral Arm' },
			{ url: ROOT + '/thirdparty/eli/EliSmile.png', name: 'Smile' },
			{ url: ROOT + '/thirdparty/eli/EliStressArm.png', name: 'Stress Arm' },
			{ url: ROOT + '/thirdparty/eli/EliStressArmsOut.png', name: 'Stress Arms Out' },
			{ url: ROOT + '/thirdparty/eli/EliStressedTalkArm.png', name: 'Stressed Talk Arm' },
			{ url: ROOT + '/thirdparty/eli/EliStressedThink.png', name: 'Stressed Think' },
			{ url: ROOT + '/thirdparty/eli/EliSurprise.png', name: 'Surprise' },
			{ url: ROOT + '/thirdparty/eli/EliSurvival.png', name: 'Survival' },
			{ url: ROOT + '/thirdparty/eli/EliSweating.png', name: 'Sweating' },
			{ url: ROOT + '/thirdparty/eli/EliSweatingArm.png', name: 'Sweating Arm' },
			{ url: ROOT + '/thirdparty/eli/EliTalk.png', name: 'Talk' },
			{ url: ROOT + '/thirdparty/eli/EliTalkArm.png', name: 'Talk Arm' },
			{ url: ROOT + '/thirdparty/eli/EliTerrifiedArm.png', name: 'Terrified Arm' },
			{ url: ROOT + '/thirdparty/eli/EliTerrifiedArms.png', name: 'Terrified Arms' },
			{ url: ROOT + '/thirdparty/eli/EliTiredArm.png', name: 'Tired Arm' },
			{ url: ROOT + '/thirdparty/eli/EliWhy.png', name: 'Why?' }
		]
	}
];
