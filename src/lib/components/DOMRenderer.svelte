...
<main bind:clientWidth={clientWidth} style='--frame-width: {clientWidth}px'>
  ...
  <div class="element textbox-text">
    <LayeredText>
      "The FitnessGram<sup>TM</sup> Pacer Test is a multistage aerobic capacity test that progressively gets more difficult as it continues..."
    </LayeredText>
  </div>
